...
public partial class ScheduleAddWin : Window
{
    ...
    {
        string sql = "INSERT INTO Schedule VALUES('" + IDTextBox.Text + "' , '" + NameTextBox.Text + "' , '" + SecondNameTextBox.Text + "' , '" + ThirdNameTextBox.Text  + "')";
